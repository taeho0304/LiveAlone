...
public class MatrixMulti3 {
	...
	// Reduce
	public static class MMReducer extends Reducer<IntTriple, IntWritable, IntTriple, IntWritable> {
		...
		public void reduce(IntTriple key, Iterable<IntWritable> values, Context context) 
			throws IOException, InterruptedException {
				...
				for ( IntWritable tx : values ) {
					/*   Fill here */
					// --------------------------------------------------
					// --------------------------------------------------
				}

				key.set(key.getV1(), key.getV2(), -1);
				val.set(sum);
	...
	public static void main(String[] args) throws Exception {
		...
		Job job = new Job(conf, "matrix multiplication 2: using secondary sort");
