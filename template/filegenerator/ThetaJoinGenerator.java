...
public class ThetaJoinGenerator {
	/*
	...
	public static void main(String[] args) throws IOException{		
		//Parameter Settings;
		if(args.length!=5){
			System.out.printf("Usage <nR> <nS> <range> <nAttrs> <seed>\n");
			System.out.println("nR: Number of tuples in R");
			System.out.println("nS: Number of tuples in S");
			System.out.println("range: Range of values [0, range)");
			System.out.println("nAttrs: Number of attributes");
		...
		int nAttrs = Integer.parseInt(args[3]);
		int seed = Integer.parseInt(args[4]);
		
		ThetaJoinGenerator dg = new ThetaJoinGenerator(nR, nS, range, nAttrs, seed);
		dg.generate();
		
		System.out.println("Completed");
		
	}
	public ThetaJoinGenerator(int nR, int nS, int range, int nAttrs, int seed){
		this.nR = nR;
		this.nS = nS;
		this.range = range;
		this.nAttrs = nAttrs;
	...
	public void generate() throws IOException{
		...
		writeArrayList("input_thetajoin.data", records);
	}
