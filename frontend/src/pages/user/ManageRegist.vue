<template>
                            ...
                            <div id="residenceInput" v-if="getUserInfo" class="col-md-10 ml-auto mr-auto" style="margin-top:0px">
                                ...
                                <div class="row collections">
                                    ...
                                    <h6 class="col-md-12 inputLabel">
                                        <label style="margin-bottom: 0px;" for="name"><span>매물 이미지</span></label>
                                    </h6>
                                    <div style="padding-left:5px; padding-right:5px;" class="col-md-12">
                                      <label class="input-file-button" for="input-file" style="z-index:99;">
                                        업로드
                                      </label>
                                      <input multiple class="filestyle" id="input-file" ref="images" type="file" style="margin-left:-71px;"/>
                                    </div>
...
<script>
    ...
    export default {
        ...
        computed: {
            ...
            get:function () { return this.residence.direction === '' ? null: this.residence.direction; },
        },
        methods: {
          ...
          clickRegistResi(){
            ...
            this.$fire({
              type: 'info',
              title: '등록완료',
              html: "매물 : "+this.categoryList[this.residence.residenceCategory-1].name+
              "<br> 거래 : "+this.typeList[this.residence.residenceType-1].name
